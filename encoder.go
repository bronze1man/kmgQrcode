...
type dataEncoder struct {
	...
	numericModeIndicator      *kmgQrcodeBitset.Bitset
	alphanumericModeIndicator *kmgQrcodeBitset.Bitset
	byteModeIndicator         *kmgQrcodeBitset.Bitset
...
func newDataEncoder(t dataEncoderType) *dataEncoder {
	...
	case dataEncoderType1To9:
		d = &dataEncoder{
			minVersion:                   1,
			maxVersion:                   9,
			numericModeIndicator:         kmgQrcodeBitset.New(b0, b0, b0, b1),
			alphanumericModeIndicator:    kmgQrcodeBitset.New(b0, b0, b1, b0),
			byteModeIndicator:            kmgQrcodeBitset.New(b0, b1, b0, b0),
...
func (d *dataEncoder) encode(data []byte) (*kmgQrcodeBitset.Bitset, error) {
	d.data = data
	d.actual = nil
	d.optimised = nil
...
// encoded.
func (d *dataEncoder) encodeDataRaw(data []byte, dataMode dataMode, encoded *kmgQrcodeBitset.Bitset) {
...
func (d *dataEncoder) modeIndicator(dataMode dataMode) *kmgQrcodeBitset.Bitset {
	switch dataMode {
	case dataModeNumeric:
